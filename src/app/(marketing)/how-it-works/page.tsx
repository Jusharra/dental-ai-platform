...
const steps = [
  ...
  },
  {
    ...
    body: 'While Serenity manages patient communications, the Dental AI Growth System simultaneously tracks your HIPAA compliance posture — policy status, BAA signatures, staff training records, license expirations, and audit logs — all in one place.',
      ...
      <section className="bg-slate-950 py-24">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-slate-400 text-lg leading-relaxed">
            The Dental AI Growth System integrates with your existing tools and has Serenity handle patient communications end-to-end, while keeping your practice fully compliant.
          </motion.p>
        </motion.div>
      </section>
      ...
      <section className="py-20 bg-slate-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-slate-400 mb-10">The Dental AI Growth System works with the tools dental practices already use.</p>
