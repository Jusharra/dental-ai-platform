...
const solutions = [
  ...
  },
  {
    ...
    body: 'Group practices face the challenge of consistency — different providers, different schedules, and multiple front desk staff. The Dental AI Growth System centralizes patient communication and compliance management under one platform.',
    features: [
      ...
      <section className="bg-slate-950 py-24">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-slate-400 text-lg leading-relaxed">
            Whether you are a solo dentist or a 50-location DSO, the Dental AI Growth System scales to meet you exactly where you are.
          </motion.p>
        </motion.div>
      </section>
