...
const categories = [
  {
    label: 'General',
    faqs: [
      { q: 'What is the Dental AI Growth System?', a: 'The Dental AI Growth System is an AI-powered patient operations platform for dental practices. It handles inbound calls, appointment recall, confirmation reminders, and HIPAA compliance management — 24/7, without any staff involvement.' },
      { q: 'Who is Serenity?', a: 'Serenity is the AI voice assistant at the core of the Dental AI Growth System. She answers calls, handles recall outreach, and confirms appointments around the clock — sounding natural, professional, and empathetic.' },
      { q: 'Who makes the Dental AI Growth System?', a: 'The Dental AI Growth System is a product of First-Choice Cyber, a technology firm focused on building compliant, AI-driven solutions for healthcare-adjacent industries.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'Is the Dental AI Growth System HIPAA compliant?', a: 'Yes. The platform is built HIPAA-compliant from the ground up. All patient data is encrypted at rest and in transit. A Business Associate Agreement (BAA) is included with every plan.' },
    ...
    <div className="pt-16">
      ...
      <section className="bg-slate-950 py-24">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-slate-400 text-lg">Everything you need to know about the Dental AI Growth System. Can&apos;t find your answer? <Link href="/contact" className="text-orange-400 hover:underline">Contact us</Link>.</motion.p>
        </motion.div>
      </section>
