...
const faqs = [
  ...
  { q: 'Is the Dental AI Growth System HIPAA compliant?', a: 'Yes. The platform includes a Business Associate Agreement (BAA) and all data is encrypted at rest and in transit.' },
]
