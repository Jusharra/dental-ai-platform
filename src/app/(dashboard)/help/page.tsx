    ...
    <div className="space-y-10 max-w-4xl">
      ...
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">
          Everything you need to get the most out of your platform
        </p>
      </div>
