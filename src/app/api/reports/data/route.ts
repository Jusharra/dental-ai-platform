...
export async function GET(request: NextRequest) {
  ...
  // practice_id only used by super_admin
  ...
  // Determine which practice to query
...
async function buildCallPerformance(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  service: any,
  practiceId: string,
  start: string,
  end: string,
): Promise<CallPerformanceData> {
