    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
        <div style="background: #0f172a; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
          <p style="color: #94a3b8; font-size: 12px; margin: 0 0 8px 0; text-transform: uppercase; letter-spacing: 0.05em;">First-Choice Cyber · PracticeGuard AI</p>
        ...
        <p style="color: #6b7280; font-size: 13px; margin-top: 24px;">This report was generated by the PracticeGuard AI. If you have questions, please contact your account manager.</p>
