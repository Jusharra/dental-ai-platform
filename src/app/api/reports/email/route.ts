    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
        <div style="background: #0f172a; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
          <p style="color: #94a3b8; font-size: 12px; margin: 0 0 8px 0; text-transform: uppercase; letter-spacing: 0.05em;">First-Choice Cyber · Dental AI Growth System</p>
        ...
        <p style="color: #6b7280; font-size: 13px; margin-top: 24px;">This report was generated by the Dental AI Growth System. If you have questions, please contact your account manager.</p>
        <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 24px 0;" />
        <p style="color: #9ca3af; font-size: 11px;">© ${new Date().getFullYear()} First-Choice Cyber. Confidential.</p>
      </div>
    `,
    attachments: [{
