    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
        <div style="background: #0f172a; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
          <p style="color: #94a3b8; font-size: 12px; margin: 0 0 8px 0; text-transform: uppercase; letter-spacing: 0.05em;">Dental Patient Operations &amp; Compliance Platform</p>
        ...
        <p style="color: #9ca3af; font-size: 11px;">© ${new Date().getFullYear()} Dental Patient Operations &amp; Compliance Platform. Confidential.</p>
      </div>
    `,
    attachments: [{
