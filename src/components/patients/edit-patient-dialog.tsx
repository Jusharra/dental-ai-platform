        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2 col-span-2">
              ...
              <Input id="patient_name" name="patient_name" defaultValue={patient.patient_name} required />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="insurance_id" name="insurance_id" defaultValue={patient.insurance_id || ''} />
            </div>
            <div className="space-y-2 col-span-2">
