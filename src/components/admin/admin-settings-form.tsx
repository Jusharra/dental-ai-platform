...
export function AdminSettingsForm({ initial }: { initial: AdminSettings }) {
  ...
  // Platform identity
  const [platformName, setPlatformName]   = useState(initial.platform_name  ?? 'PatientGuard AI')
      ...
      <Section title="Platform Identity">
        ...
        >
          <div className="grid grid-cols-2 gap-3">
            <Field label="Platform Name"  id="platform_name"  value={platformName}  onChange={setPlatformName}  placeholder="PatientGuard AI" />
      ...
      <Section title="Platform Email (Resend)">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="From Name"    id="from_name"  value={fromName}   onChange={setFromName}   placeholder="PatientGuard AI" />
          </div>
